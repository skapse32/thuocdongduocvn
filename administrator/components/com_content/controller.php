...
class ContentController extends JController
{
    ...
    */
    function viewContent()
    {
        ...
        $lists['catid'] = JHTML::_('list.subcategory', 'catid', $filter_sectionid, $catid, 'class="inputbox" size="1" '. $javascript); //ContentHelper::filterCategory($query, $catid);
    ...
    */
    function editContent($edit)
    {
        ...
        $categories = array();
        foreach ($sectioncategories[$row->sectionid] as $cat) {
            $categories[] = $cat;
        }
     ...
     * cat_list is an array of category objects
     */
    function selectParentCategory ( &$cat_list )
    {
        $db =& JFactory::getDBO();
