...
class cf_joomla_registration  {
	...
	<table border="0" cellpadding="3" cellspacing="0">
        ...
        <tr style="background-color:#c9c9c9 ">
			<td><?php echo JHTML::_('tooltip', "you may want the plugin to advance with the registration even if Joomla's global \"Allow user registration\" setting is turned OFF!" ); ?></td>
			<td><strong><?php echo "Override Joomla's Allow User Registration"; ?>:</strong> </td>
			<td></td>
			<td>
			<select name="params[overrideJallowUserRegistration]" id="params[overrideJallowUserRegistration]">
				<option<?php if($paramsvalues->get('overrideJallowUserRegistration') == '0'){ echo ' selected';} ?> value="0">No</option>
				<option<?php if($paramsvalues->get('overrideJallowUserRegistration') == '1'){ echo ' selected';} ?> value="1">Yes</option>
			</select>
		</td>
		</tr>
		<tr style="background-color:#c9c9c9 ">
