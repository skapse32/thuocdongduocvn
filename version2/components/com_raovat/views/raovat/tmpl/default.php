...
?>
 <div class="mdl-cnt">
	...
	?>	
        ...
        <?php endif;?>
        <h2> <a href="<?php echo JRoute::_("index.php?option=com_raovat&view=raovat&layout=canban&Itemid=29");?>">
            cần bán</a></h2>
 ...
 <div class="mdl-cnt">
	...
	?>	
	  ...
	  ?>
        <h2><a href="<?php echo JRoute::_("index.php?option=com_raovat&view=raovat&layout=canmua&Itemid=30");?>">
            cần mua</a></h2>
        <img src="<?php echo $templateUrl;?>/images/news&amp;event_107.png" />
