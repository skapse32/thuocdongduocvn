...
?>
<link rel="stylesheet" href="modules/mod_small_photo_slide/asset/style.css" />
 <div id="moduel9_tinanh">
	<div id="moduel9_tinanh_title">
        <div id="moduel9_tinanh_title_bor"></div>
        <div id="moduel9_tinanh_title_bor_1">
            <a>ẢNH PHÓNG SỰ</a>
        </div>
    </div>
	<div id="moduel9_tinanh_content">
		<ul id="slideshow">
			<?php 			
