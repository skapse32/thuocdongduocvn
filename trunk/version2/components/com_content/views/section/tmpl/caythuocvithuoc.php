...
<div class="mdl-cnt">
	...
	if($have_images)
	{
		...
		$item->imgLink= $m[1][0];
			...
			?>
			<div class="list-box2">
				<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($item->slug, $item->catslug, $item->sectionid)).'&Itemid=4';?>">
					<?php if(!empty($item->imgLink)):?>
					<img src="<?php echo $item->imgLink;?>" alt="Loading" class="img2" />
					<?php endif;?>
					</a> <a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($item->slug, $item->catslug, $item->sectionid)).'&Itemid=4';?>" class="link_title">
