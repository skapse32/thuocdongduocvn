 ...
 * @since 1.5
 */
class ContentModelSectionFrontPageHelper extends JModel
{
	/**
	 * Category id
	 *
	...
	function _buildQuery($state = 1)
	{
		...
		$query = 'SELECT f.ordering AS f_ordering, a.id, a.title, a.alias, a.title_alias, a.introtext, a.fulltext, a.sectionid, a.state, a.catid, a.created, a.created_by, a.created_by_alias, a.modified, a.modified_by,' .
	...
	{
		$filter_order		= JRequest::getCmd('filter_order','f_ordering');
